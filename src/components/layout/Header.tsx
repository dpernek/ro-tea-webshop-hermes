    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/95 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/lista-zelja" className="hover:text-brand relative flex h-10 w-10 items-center justify-center rounded-lg text-slate-700 transition-colors hover:bg-slate-100" aria-label="Lista želja">
            <Heart className="h-5 w-5" />
            {wishlistCount > 0 && <span className="bg-red-500 absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold text-white">{wishlistCount}</span>}
          </Link>
          <Link
            href="/kosarica"
