...
const catalogs = [
  {
    ...
    image: "/images/catalogs/pferd-2026.webp",
    url: "https://int.pferd.com/en/service/downloads/?oxDeeplink=eyJ1bm...fX19",
  },
  {
    name: "FESTA katalog 2025–2026",
    brand: "FESTA",
    description: "Veliki izbor FESTA alata za profesionalce.",
    image: "/images/catalogs/festa-2025.webp",
  ...
  },
  {
    ...
    image: "/images/catalogs/metabo.webp",
  ...
  },
  {
    ...
    image: "/images/catalogs/delta-plus.webp",
  ...
  },
  {
    ...
    image: "/images/catalogs/knipex.webp",
  ...
  },
  {
    ...
    image: "/images/catalogs/dormer-holemaking.webp",
  ...
  },
  {
    ...
    image: "/images/catalogs/dormer-threading.webp",
  ...
  },
  {
    ...
    image: "/images/catalogs/dormer-repair.webp",
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <AnimatedSection>
            ...
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-400">
              ...
              Metabo, Knipex, Dormer Pramet i Delta Plus.
            </p>
          </AnimatedSection>
        </div>
      </section>
            ...
            {catalogs.map((cat, i) => (
              <AnimatedSection key={cat.name} delay={i * 0.05}>
                <a
                  ...
                  className="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-800 bg-slate-900/50 transition-all hover:-translate-y-1 hover:border-slate-700 hover:shadow-lg hover:shadow-slate-900/50"
                >
                  {/* Cover image */}
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    <p className="text-xs font-semibold tracking-wide text-[#0055a8] uppercase">
                      {cat.brand}
                    </p>
                    <h3 className="mt-1 text-lg font-semibold text-white group-hover:text-[#0055a8] transition-colors">
                      {cat.name}
                    </h3>
