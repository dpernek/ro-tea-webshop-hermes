    ...
    <div className="space-y-8">
        ...
        <div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {stockAlerts.length > 0 && (
              <Link href="/admin/products?lowStock=yes" className="rounded-lg border border-red-200 bg-red-50 p-4 hover:shadow-sm transition-shadow">
      ...
      {stockAlerts.length > 0 && (
        <div>
          ...
          <div className="mt-3">
            <Link href="/admin/products?lowStock=yes" className="text-xs font-medium text-indigo-600 hover:text-indigo-700">Svi proizvodi niske zalihe →</Link>
          </div>
        </div>
      )}
